...
class TrackballControlsCustom extends EventDispatcher {
    constructor(object, domElement) {
        ...
        __publicField(this, "onMouseDown", (event) => {
            ...
            this.domElement.ownerDocument.addEventListener('mousemove', this.onPointerMove);
        ...
        __publicField(this, "onMouseUp", () => {
            ...
            if (this.enabled === false)
                return;
            this._state = this.STATE.NONE;
            this.domElement.ownerDocument.removeEventListener("mousemove", this.onPointerMove);
        ...
        __publicField(this, "connect", (domElement) => {
            ...
            this.domElement.addEventListener("mousemove", this.onPointerDown);
            ...
            this.domElement.addEventListener("mousemove", this.touchmove);
            this.domElement.ownerDocument.addEventListener("mousemove", this.onPointerMove);
            this.domElement.ownerDocument.addEventListener("pointerup", this.onPointerUp);
            window.addEventListener("keydown", this.keydown);
        ...
        __publicField(this, "dispose", () => {
            ...
            this.domElement.removeEventListener("mousemove", this.onPointerDown);
            ...
            this.domElement.removeEventListener("mousemove", this.touchmove);
            this.domElement.ownerDocument.removeEventListener("mousemove", this.onPointerMove);
            this.domElement.ownerDocument.removeEventListener("pointerup", this.onPointerUp);
            window.removeEventListener("keydown", this.keydown);
